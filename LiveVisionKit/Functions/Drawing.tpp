...
//---------------------------------------------------------------------------------------------------------------------
    ...
    inline cv::Scalar col::rgb2yuv(const cv::Scalar& rgb)
    {
        return cv::Scalar(
             0.257 * rgb[0] + 0.504 * rgb[1] + 0.098 * rgb[2] + 16,
            -0.148 * rgb[0] - 0.291 * rgb[1] + 0.439 * rgb[2] + 128,
             0.439 * rgb[0] - 0.368 * rgb[1] - 0.071 * rgb[2] + 128
        );
    }
